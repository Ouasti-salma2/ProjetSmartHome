...
namespace pfa__.net.Controllers
{
    ...
    public class ConditionsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            return Ok(ConditionMapper.ToViewModelList(conditions));
        }
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            return Ok(ConditionMapper.ToViewModel(condition));
        }

        // POST: api/conditions
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] ConditionCreateViewModel vm)
        {
            if (!ModelState.IsValid) return BadRequest(ModelState);
            var model = ConditionMapper.ToModel(vm);
            ...
            return CreatedAtAction(nameof(GetById), new { id = created.Id },
                ConditionMapper.ToViewModel(withEquipement!));
        }
